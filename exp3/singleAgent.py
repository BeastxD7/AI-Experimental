...
# 1. Initialize shared LLM (unchanged)
llm = Ollama(
    model="llama3.1:8b",
...
async def main():
    """Main interactive loop - REPLACES YOUR STATIC EXAMPLES"""
    print("="*60)
    ...
    while True:  # CONTINUOUS INTERACTIVE LOOP
        try:
            ...
            if user_input.lower() in ['exit', 'quit']:
                ...
                ctx = Context(agent)  # Reset context
